...
/* Define to 1 if you want to use the PostgreSQL backend */
/* #undef MPC_POSTGRESQL */

/* Define to 1 if you want SQLite as standard */
/* #undef MPC_PREFER_SQLITE */
